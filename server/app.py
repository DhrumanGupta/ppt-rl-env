...
"""
FastAPI application for the Ppt Agent Environment.

This module creates an HTTP server that exposes the PptAgentEnvironment
...
def main(host: str = "0.0.0.0", port: int = 7860):
    ...
    multiple workers:
        uvicorn ppt_agent.server.app:app --workers 4
    """
    import uvicorn
